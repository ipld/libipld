...
#[inline]
pub fn write_null<W: Write + Unpin + Send>(w: &mut W) -> Result<()> {
    w.write_all(&[0xf6])?;
    Ok(())
}

#[inline]
pub fn write_u8<W: Write + Unpin + Send>(w: &mut W, major: u8, value: u8) -> Result<()> {
    if value <= 0x17 {
...
#[inline]
pub fn write_u16<W: Write + Unpin + Send>(w: &mut W, major: u8, value: u16) -> Result<()> {
...
#[inline]
pub fn write_u32<W: Write + Unpin + Send>(w: &mut W, major: u8, value: u32) -> Result<()> {
...
#[inline]
pub fn write_u64<W: Write + Unpin + Send>(w: &mut W, major: u8, value: u64) -> Result<()> {
...
#[inline]
pub fn write_tag<W: Write + Unpin + Send>(w: &mut W, tag: u64) -> Result<()> {
    write_u64(w, 6, tag)
}

pub trait WriteCbor {
    fn write_cbor<W: Write + Unpin + Send>(&self, w: &mut W) -> Result<()>;
}
